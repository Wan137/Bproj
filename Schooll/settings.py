"""
Django settings for Schooll project.
...
SECRET_KEY = 'django-insecure-om2s7-%t6(npnl)#&-x+fqdad0#uxycgzj@dty7@c_)juel!n9'
...
WSGI_APPLICATION = 'Schooll.wsgi.application'
